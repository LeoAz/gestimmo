...
class RentalController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'tenant_first_name' => 'required_without:tenant_id|string|max:255',
            'tenant_last_name' => 'required_without:tenant_id|string|max:255',
            'tenant_phone' => 'required_without:tenant_id|string|max:255',
            ...
            'payment_frequency' => 'required|string|in:monthly,quarterly,semiannual',
